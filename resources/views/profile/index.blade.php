    ...
    <div class="bg-white border-b">
        <div class="container mx-auto px-4">
            <nav class="flex space-x-8">
                <a href="#" class="tab-link py-4 px-1 border-b-2 border-blue-600 text-blue-600 font-medium">Posts</a>
                <a href="#" class="tab-link py-4 px-1 text-gray-600 hover:text-blue-600 transition">Comments</a>
                <a href="#" class="tab-link py-4 px-1 text-gray-600 hover:text-blue-600 transition">Bookmarks</a>
                <a href="#" class="tab-link py-4 px-1 text-gray-600 hover:text-blue-600 transition">Stats</a>
                <a href="#" class="tab-link py-4 px-1 text-gray-600 hover:text-blue-600 transition">Settings</a>
            </nav>

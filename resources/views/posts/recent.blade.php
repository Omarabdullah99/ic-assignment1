<main class="lg:w-2/3">
    ...
    <div class="space-y-8">
        ...
        <article
            ...
            <div class="p-6 md:w-2/3">
                <div class="flex items-center text-sm text-gray-500 mb-2">
                    <a href="{{ route('categories.show', 'cyber-security') }}"><span
                            class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs">Cybersecurity</span></a>
                    <span class="mx-2">•</span>
        ...
        <article
            ...
            <div class="p-6 md:w-2/3">
                <div class="flex items-center text-sm text-gray-500 mb-2">
                    <a href="{{ route('categories.show', 'development') }}"><span
                            class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs">Development</span></a>
                    <span class="mx-2">•</span>

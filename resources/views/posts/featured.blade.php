     ...
     <div class="container mx-auto px-4">
         ...
         <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
             ...
             <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                 ...
                 <div class="p-6">
                     <div class="flex items-center text-sm text-gray-500 mb-2">
                         <a href="{{ route('categories.show', 'artificial-initelligence') }}"><span
                                 class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs">Artificial
                                 Intelligence</span></a>
                         <span class="mx-2">•</span>
             ...
             <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                 ...
                 <div class="p-6">
                     <div class="flex items-center text-sm text-gray-500 mb-2">
                         <a href="{{ route('categories.show', 'cloud-computing') }}"><span
                                 class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs">Cloud
                                 Computing</span></a>
                         <span class="mx-2">•</span>

...
{{-- <header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 md:py-0 flex justify-between items-center">
        ...
        <nav class="hidden md:flex space-x-8 items-center">
            ...
            <div class="relative desktop-dropdown">
                <button type="button" class="text-gray-600 hover:text-blue-600 py-4 transition flex items-center">
                    Categories
                ...
                <div class="absolute left-0 w-64 bg-white rounded-md shadow-lg hidden z-50 desktop-dropdown-menu">
                    <div class="py-2">
                        <div class="relative desktop-dropdown-sub">
                            <a href="{{ route('categories.show', 'web-development') }}"
                                class="px-4 py-2 text-gray-700 hover:bg-gray-100 transition flex justify-between items-center w-full text-left">
                                Web Development
        ...
        <div class="flex items-center space-x-4">
            <button type="button" class="md:hidden text-gray-600" id="mobile-menu-button">
                <i class="fas fa-bars text-xl"></i>
            </button>
            <div class="relative">
                <button type="button" id="userMenuButton" class="flex items-center space-x-2 focus:outline-none">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white shadow-md">
        <div class="container mx-auto px-4 py-4">
            ...
            <div class="relative">
                <button type="button"
                    class="py-2 text-gray-600 hover:text-blue-600 transition flex items-center w-full text-left mobile-dropdown-toggle">
                    Categories
                    <i class="fas fa-chevron-down ml-1 text-sm"></i>
                </button>
                <div id="mobile-categories" class="hidden pl-4 mobile-dropdown-menu">
                    <div class="py-1">
                        <div class="relative">
                            <button type="button"
                                class="py-2 text-gray-600 hover:text-blue-600 transition flex items-center w-full text-left mobile-dropdown-sub-toggle">
                                Web Development
                                <i class="fas fa-chevron-down ml-1 text-sm"></i>
                            </button>
            ...
            <div class="relative desktop-dropdown">
                ...
                <div class="absolute left-0 w-64 bg-white rounded-md shadow-lg hidden z-50 desktop-dropdown-menu">
                    <div class="py-2">
                        ...
                        <div class="relative desktop-dropdown-sub">
                            <a href="{{ route('categories.show', 'artificial-intelligence') }}"
                                class=" px-4 py-2 text-gray-700 hover:bg-gray-100 transition flex justify-between items-center w-full text-left">
                                Artificial Intelligence
                                <i class="fas fa-chevron-right text-xs"></i>
                            </a>
                            <div
                                ...
                                <a href="#"
                                    ...
                                    Learning</a>
                                <a href="#"
                                    class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition">Deep
                                    Learning</a>
                                <a href="#"
                        ...
                        <a
                            href="{{ route('categories.show', 'cloud-computin') }}"class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition">Cloud
                            Computing</a>
                        <a href="{{ route('categories.show', 'cyber-security') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition">Cybersecurity</a>
                        <a href="{{ route('categories.show', 'mobile-development') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition">Mobile Development</a>
                        <a href="{{ route('categories.show', 'dev-ops') }}"
            ...
            <div class="relative">
                ...
                <div id="mobile-categories" class="hidden pl-4 mobile-dropdown-menu">
                    <div class="py-1">
                        ...
                        <div class="relative">
                            <a href="{{ route('categories.show', 'artificial-intellignece') }}"
                                class=" py-2 text-gray-600 hover:text-blue-600 transition flex items-center w-full text-left mobile-dropdown-sub-toggle">
                                Artificial Intelligence
                                <i class="fas fa-chevron-down ml-1 text-sm"></i>
                            </a>
                            <div id="mobile-ai-submenu" class="hidden pl-4 mobile-dropdown-submenu">
                                <a href="#"
                                    class="block py-2 text-gray-600 hover:text-blue-600 transition">Machine
                                    Learning</a>

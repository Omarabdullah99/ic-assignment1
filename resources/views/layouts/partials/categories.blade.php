<div class="bg-white p-6 rounded-lg shadow">
    ...
    <div class="space-y-2">
        <a href="{{ route('categories.show', 'web-development') }}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
            <span class="text-gray-700">Web Development</span>
            <span class="bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">12</span>
        </a>
        <a href="{{ route('categories.show', 'artificial-intelligence') }}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
        ...
        <a href="{{ route('categories.show', 'cloud-computing') }}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
            <span class="text-gray-700">Cloud Computing</span>
            <span class="bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">5</span>
        </a>
        <a href="{{ route('categories.show', 'cyber-security') }}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
            <span class="text-gray-700">Cybersecurity</span>
            <span class="bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">7</span>
        </a>
        <a href="{{ route('categories.show', 'mobile-development') }}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
        ...
        <a href="{{ route('categories.show', 'dev-ops') }}" class="flex justify-between items-center p-2 hover:bg-gray-100 rounded-md transition">
